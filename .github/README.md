...
[`@aws-sdk/client-fms`](https://www.npmjs.com/package/@aws-sdk/client-fms/v/3.714.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fms@3.714.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OLalgyWYt0siJp61IRvGPzsBbHoNcfeR86IDk58S3sZep6KSpL5PG+Le43XRB4Qv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-fms": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fms@3.714.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fms@3.714.0/index.min.mjs": "sha384-OLalgyWYt0siJp61IRvGPzsBbHoNcfeR86IDk58S3sZep6KSpL5PG+Le43XRB4Qv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-fms/blob/refs/tags/3.714.0/LICENSE
```
