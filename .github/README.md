...
[`@aws-sdk/client-fms`](https://www.npmjs.com/package/@aws-sdk/client-fms/v/3.1039.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fms@3.1039.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2Gne4swnEJ+NIxTqE4Vmthb3wSlPI2hvjQRlAddvRM/FSoP9CyErLSLcX+y9r7v5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-fms": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fms@3.1039.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fms@3.1039.0/index.min.mjs": "sha384-2Gne4swnEJ+NIxTqE4Vmthb3wSlPI2hvjQRlAddvRM/FSoP9CyErLSLcX+y9r7v5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-fms/blob/refs/tags/3.1039.0/LICENSE
```
